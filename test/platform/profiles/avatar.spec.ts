...
const AVATAR_INFO = {
  bodyShape: 'urn:beland:off-chain:base-avatars:BaseMale',
  snapshots: {
  ...
  wearables: [
    'urn:beland:off-chain:base-avatars:tall_front_01',
    'urn:beland:off-chain:base-avatars:eyes_08',
    'urn:beland:off-chain:base-avatars:eyebrows_00',
    'urn:beland:off-chain:base-avatars:mouth_05',
    'urn:beland:matic:collections-v2:0xf6f601efee04e74cecac02c8c5bdc8cc0fc1c721:0',
    'urn:beland:off-chain:base-avatars:classic_shoes',
    'urn:beland:off-chain:base-avatars:red_tshirt',
    'urn:beland:off-chain:base-avatars:trash_jean'
  ]
}
