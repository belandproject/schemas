...
describe('NFT tests', () => {
  describe('parcel', () => {
    const parcel: NFT = {
      ...
      name: 'The Dope Spot',
      image: 'https://api.beland.org/v1/parcels/-63/-115/map.png',
  ...
  describe('estate', () => {
    const estate: NFT = {
      ...
      name: 'Fashion Hall',
      image: 'https://api.beland.org/v1/estates/4302/map.png',
  ...
  describe('wearable', () => {
    const wearable: NFT = {
      ...
      name: 'HypnoVision',
      image:
        'https://peer.beland.org/lambdas/collections/contents/urn:beland:matic:collections-v2:0xabb0ca6ee85825f6d7f549ef36bf571484c157c5:0/thumbnail',
